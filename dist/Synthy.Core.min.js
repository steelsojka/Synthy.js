 ...
 * MIT Licensed
 */
var Synthy=function(b){b.Core=function(a){a=a||{};this.context=a.context||new webkitAudioContext;this._voices={};this.load(a.patch)};b.Core.prototype={trigger:function(a,d){if(this.patch&&!(a in this._voices)){var c=new b.Voice({noteNumber:a,velocity:d},this.patch,this.context);c.output.connect(this.drive.input);this._voices[a]=c;c.trigger()}},release:function(a){a in this._voices&&(this._voices[a].release(),delete this._voices[a])},kill:function(){for(var a in this._voices)this._voices[a].kill()},
...
a]=function(b,c){this.patch.setOscillatorProperty(b,a.charAt(0).toLowerCase()+a.slice(1),c)}});b.create=function(a){return new b.Core(a)};return b}(Synthy||{});
